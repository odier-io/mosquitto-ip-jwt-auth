...
(
  ...
  CFLAGS='-fPIC -Wno-unused-result -Wno-stringop-overflow' cmake -DBUILD_SHARED_LIBS=Off -DL8W8JWT_PACKAGE=On -DL8W8JWT_ENABLE_EDDSA=On -DCMAKE_BUILD_TYPE=Release ..
